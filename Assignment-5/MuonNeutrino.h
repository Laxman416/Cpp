...
public:
  ...
  MuonNeutrino(bool is_antiparticle, double particle_energy, double particle_px, double particle_py, double particle_pz, bool has_interacted) :
    // Call Parameterised Constructor for ChargedLepton
    NeutralLepton(is_antiparticle, 5e-7 ,m_is_antiparticle ? "Muon Neutrino":"Muon Antineutrino", particle_energy, particle_px, particle_py, particle_pz),
